...
public class STSSupport {
    ...
    private String getEnvVariable(String name) {
        return sakConfiguration.getRequiredString(name);
    }
    ...
    public String getSystemSAMLTokenFromSTS() {
        ...
        try {
            ...
            stsClient.getClient().getRequestContext().put(Message.ENDPOINT_ADDRESS, "https://sts-t6.test.local/SecurityTokenServiceProvider/");
